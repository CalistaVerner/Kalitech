// FILE: org/foxesworld/kalitech/engine/modules/physics/query/PhysicsRaycasts.java
...
import static org.foxesworld.kalitech.engine.modules.physics.query.RaycastPayloads.hitObj;
...
public final class PhysicsRaycasts {
    ...
    public PhysicsRaycasts(Access access) {
        this.access = Objects.requireNonNull(access, "access");
    }

    public Object raycastAll(Object cfg) {
        access.flushPendingAdd();
        PhysicsSpace space = access.requireSpace();
        ...
        for (PhysicsRayTestResult r : hits) {
            ...
            PhysicsBodyHandle h = access.findHandleByCollisionObject(r.getCollisionObject());
            if (h == null) continue;
    ...
    public PhysicsRayHit raycast(Object cfg) {
        ...
        PhysicsBodyHandle h = access.findHandleByCollisionObject(best.getCollisionObject());
        if (h != null) {
            bodyId = h.id;
    ...
    public Object raycastEx(Object cfg) {
        ...
        PhysicsBodyHandle bh = access.findHandleByCollisionObject(best.getCollisionObject());
    ...
    public interface Access {
        ...
        PhysicsBodyHandle findHandleByCollisionObject(Object collisionObject);
    }
}