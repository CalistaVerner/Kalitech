...
public final class TerrainNoise {
    ...
    public float[] perlinHeights(Value cfg) {
        return heights(Type.PERLIN, cfg);
    }
    ...
    public float[] ridgedHeights(Value cfg) {
        return heights(Type.RIDGED, cfg);
    }

    public float[] perlinWarpHeights(Value cfg) {
        return heights(Type.PERLIN, cfg, true);
    }
    ...
    public float[] ridgedWarpHeights(Value cfg) {
        return heights(Type.RIDGED, cfg, true);
    }
    ...
    public float[] heights(Type type, Value cfg) {
        return heights(type, cfg, false);
    }
